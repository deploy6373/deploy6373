...
TOKEN = os.getenv('TELEGRAM_TOKEN', '7688861803:AAFUu3Br4kDckYy1SAtWQFFCqDt8Fy0vIo8')
ADMIN_ID = os.getenv('ADMIN_ID', '7004140373')
ADMIN_BKASH_NO = os.getenv('ADMIN_BKASH_NO', '01883020171')
BOT_USERNAME = os.getenv('BOT_USERNAME', "digitalbuysellbdbot")
