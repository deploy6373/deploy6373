...
TOKEN = os.getenv('TELEGRAM_TOKEN', '7728282096:AAEVhOuxzMT-xfwBmMtk5gUs-HTpk5US0oQ')
ADMIN_ID = os.getenv('ADMIN_ID', '7943354448')
ADMIN_BKASH_NO = os.getenv('ADMIN_BKASH_NO', '01883020171')
BOT_USERNAME = os.getenv('BOT_USERNAME', "digitalbuysellbd71bot")
...
def load_data():
    """Simulate loading data (replace with actual database code)"""
    pass
...
def process_gmail_quantity(message):
    ...
    try:
        ...
        price = 15 * quantity if "USA" in users[user_id]["gmail_type"] else 10 * quantity    
        users[user_id]["gmail_price"] = price    
        save_data()
        
        bot.send_message(message.chat.id,     
                        f"📝 অর্ডার সারাংশ:\n\n{users[user_id]['gmail_type']}\nপরিমাণ: {quantity}\nমোট মূল্য: {price} TK\n\nপেমেন্ট মাধ্যম:",     
